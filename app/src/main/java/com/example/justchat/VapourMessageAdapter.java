...
public class VapourMessageAdapter extends RecyclerView.Adapter<VapourMessageAdapter.MessageViewHolder> {
    private List<VapourMessages> usermessageslist;
    private DatabaseReference userref;
    private FirebaseAuth mAuth;
    private OnMessageListener mOnMessageListener;
    private int i;

    public VapourMessageAdapter(List<VapourMessages> usermessageslist,OnMessageListener onMessageListener){
        this.usermessageslist=usermessageslist;
        this.mOnMessageListener=onMessageListener;
    }


    public VapourMessageAdapter(List<VapourMessages> usermessageslist) {
        this.usermessageslist = usermessageslist;
    }
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder holder, final int position) {
        ...
        VapourMessages messages=usermessageslist.get(position);
